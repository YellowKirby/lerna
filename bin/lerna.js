...
var cli = meow([
  ...
  "  --skip-temp-tag         Skip creating a temporary tag, publishing with the property dist-tag instead (only affects publish)",
  ...
  "  --registry [registry]   Run all npm commands against the specified registry",
  ...
  "  --only-explicit-updates Only bump versions for packages that have been updated explicitly rather than cross-dependencies",
  ...
  "  --concurrency [number]  How many threads to use if lerna parallelises the tasks (defaults to 4)",
